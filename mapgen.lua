...
do
	local nodes = {
		...
		{"concrete2", "cityscape:concrete2"},
		{"concrete3", "cityscape:concrete3"},
		{"concrete4", "cityscape:concrete4"},
		{"concrete5", "cityscape:concrete5"},
		{"brick", "default:brick"},
		{"sandstone_brick", "default:sandstonebrick"},
		{"stone_brick", "default:stonebrick"},
		{"desert_stone_brick", "default:desert_stonebrick"},
