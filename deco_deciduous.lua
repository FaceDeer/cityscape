...
-- Cherries
cityscape.schematics.cherry_trees = {}
do
	local max_r = 3
	local fruit = nil

	for r = 2,max_r do
		local schem = cityscape.generate_tree_schematic(2, {x=r, y=r, z=r}, "cityscape:cherry_blossom_tree", "cityscape:cherry_blossom_leaves", fruit)

		cityscape.schematics.cherry_trees[#cityscape.schematics.cherry_trees+1] = schem
...
-- Birch trees
cityscape.schematics.birch_trees = {}
do
	local max_h = 4

	for h = 2,max_h do
		local schem = cityscape.generate_tree_schematic(h, {x=2, y=3, z=2}, "cityscape:birch_tree", "cityscape:birch_leaves")

		cityscape.schematics.birch_trees[#cityscape.schematics.birch_trees+1] = schem
